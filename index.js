      ...
      if (allowHost) {
        ...
        if (allowBot) {
          ...
          if (ipGoogleBot.status || ipBingBot.status) {
            ...
            res.end(
              host.toString() +
                " - Sorry your access was denied!. you are masquerading as a 'bot crawler'. But your ip is not 'bot crawler' ip. byee. :)"
            );
          }
        } else {
          ...
          if (blockUa) {
            ...
            res.end(
              host.toString() +
                " - Sorry your access was denied!. 'bot crawler' is not allowed."
            );
          } else {
            ...
            if (blockDDOS.status) {
              ...
              res.end(
                host.toString() +
                  " - Sorry your access was denied!. You are making too many requests. Your IP has been blocked within the next 12 hours. goodbye.. :)"
              );
            } else {
